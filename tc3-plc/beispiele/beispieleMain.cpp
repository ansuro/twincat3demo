...
class CbeispieleCtrl : public ITcOCFCtrlImpl<CbeispieleCtrl, CbeispieleClassFactory>
{
public:
	CbeispieleCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("beispiele: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CbeispieleCtrl>;
